...
function instanceToTree(inst) {
  ...
  if (inst._tag) {
    ...
    return {
      ...
      rendered: (0, _object4['default'])(children).map(instanceToTree)
    };
  }
...
var ReactFourteenAdapter = function (_EnzymeAdapter) {
  _inherits(ReactFourteenAdapter, _EnzymeAdapter);

  function ReactFourteenAdapter() {
    _classCallCheck(this, ReactFourteenAdapter);

    var _this = _possibleConstructorReturn(this, (ReactFourteenAdapter.__proto__ || Object.getPrototypeOf(ReactFourteenAdapter)).call(this));
  ...
  _createClass(ReactFourteenAdapter, [{
